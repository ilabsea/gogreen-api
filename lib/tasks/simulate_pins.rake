namespace :simulate do
  ...
  def generate_pins(amount)
    ...
    latitudes = [11.5622, 11.5736, 11.5849, 11.5515, 11.5927, 11.6002, 11.5396, 11.5413, 11.5239, 11.511, 11.5005, 11.4928, 11.4842, 11.4711, 11.6196, 11.629, 11.3421, 11.5506, 10.5506, 11.206];
